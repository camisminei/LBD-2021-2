...
DROP TABLE IF EXISTS depto_localizacoes CASCADE;
...
ALTER TABLE departamento ADD CONSTRAINT gerente FOREIGN KEY (cpf_gerente) REFERENCES funcionario(cpf);
ALTER TABLE depto_localizacoes ADD CONSTRAINT dnumerolocal FOREIGN KEY (dnumero) REFERENCES departamento(dnumero);
ALTER TABLE projeto ADD CONSTRAINT dnumprojeto FOREIGN KEY (dnum) REFERENCES departamento(dnumero);
ALTER TABLE funcionario ADD CONSTRAINT numerodepto FOREIGN KEY (dnr) REFERENCES departamento(dnumero);
ALTER TABLE trabalha_em ADD CONSTRAINT numeroprojeto FOREIGN KEY (pnr) REFERENCES projeto(projnumero);
ALTER TABLE trabalha_em ADD CONSTRAINT cpftrabalhaem FOREIGN KEY (fcpf) REFERENCES funcionario(cpf);
ALTER TABLE dependente ADD CONSTRAINT cpffuncionario FOREIGN KEY (fcpf) REFERENCES funcionario(cpf);
ALTER TABLE funcionario ADD CONSTRAINT supervisor FOREIGN KEY (cpf_supervisor) REFERENCES funcionario(cpf);